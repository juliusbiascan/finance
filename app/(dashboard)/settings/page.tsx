      ...
      <Card className="border-none drop-shadow-sm">
        ...
        <CardContent>
          <div className="flex flex-col items-center justify-center py-8">
            <div className="mb-4">
              {/* Example wallet icon (replace with your own SVG or icon component) */}
            ...
            <p className="text-gray-500 mb-6 text-center max-w-md">
              Securely link your crypto wallet to manage your account settings and access personalized features.
            </p>
            <button
